...
export default function Technologies ({ theme }) {
  ...
  return (
    <div id='technologies' className={`${theme.technologies} ${albertSansBold.className}`}>
      <h2 className={theme.sectionTitle}>Tecnologías que uso</h2>

      <div className={theme.technologiesContainer}>

        <div style={slideIn} className={theme.technology} ref={ref}>
          <Image src='/technologies/nextjs.svg' alt='Next.js' width={90} height={90} />
        </div>
        <div style={slideIn} className={theme.technology}>
